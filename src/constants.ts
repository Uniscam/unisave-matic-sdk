...
export const INIT_CODE_HASH_MATIC = '0x9841ec516cae9d69ef443e6a3abb727aed683e9fb8fd7c9443855373e563d658'
type Hashes = { [chainId in ChainId]: string }
export const INIT_CODE_HASHES: Hashes = {
  ...
  [ChainId.MATIC_MUMBAI]: INIT_CODE_HASH_MATIC
}
